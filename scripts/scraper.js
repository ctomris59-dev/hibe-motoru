...
const KAYNAKLAR = [
  // ── Google News (GitHub'dan her yerden erişilir) ────────────────────────────
  ...
  // ── Doğrudan RSS kaynakları (GitHub Actions'tan erişilebilir) ──────────────
...
function rssBasliklari(xml, max = 12) {
  ...
  // Atom feed desteği (<entry> etiketi)
